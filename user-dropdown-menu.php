...
Description: Insert a dropdown menu with a icon button, based on Bootstrap 4.0 Dropdown.
Version: 1.0.8
Author: SAGAIO
...
class UserDropdownMenu {
    ...
    static function sagaio_udm_customize_register( $wp_customize ) {
        ...
        $login_form_hwmp[] = array( 'slug'=>'sagaio_udm_login_header_margin_bottom', 'default' => '20', 'label' => __( 'Login header margin-bottom', 'sagaio-udm' ) );
        ...
        $login_form_hwmp[] = array( 'slug'=>'sagaio_udm_login_input_width', 'default' => '168', 'label' => __( 'Input fields width', 'sagaio-udm' ) );
    ...
    static function echo_customizer_styles() {
        ...
        $sagaio_udm_login_input_width = get_option('sagaio_udm_login_input_width', '168');
        ...
        $sagaio_udm_login_button_background_color = get_option('sagaio_udm_login_button_background_color', '#ffffff');
        $sagaio_udm_login_button_color = get_option('sagaio_udm_login_button_color', '#1b1b1b');
        ...
        $sagaio_udm_login_header_margin_bottom = get_option('sagaio_udm_login_header_margin_bottom', '20');
    ...
    // static function write_placeholder_script() {

    //     $sagaio_udm_login_text_username_placeholder = get_option('sagaio_udm_login_text_username_placeholder', __('Username', 'sagaio-udm'));
    //     $sagaio_udm_login_text_password_placeholder = get_option('sagaio_udm_login_text_password_placeholder', __('Password', 'sagaio-udm'));
    ...
    //     file_put_contents(WP_PLUGIN_DIR.'/user-dropdown-menu/js/placeholder.js', $script);
    ...
    static function handle_shortcode($atts) {
        ...
        if( ($locations = get_nav_menu_locations()) && (isset($locations[$holder]))) {
            ...
            //     $operation = self::write_placeholder_script();
            //     self::$add_placeholder_script = true;
            // }
    ...
    // static function register_placeholder_script() {
    //     wp_register_script( 'sagaio-udm-placeholder', plugins_url( 'js/placeholder.js', __FILE__ ), array( 'jquery'), '1.0', true );
    // }
    ...
    static function enqueue_scripts() {
        if ( ! self::$add_scripts )
            return;
        wp_enqueue_scripts('udm-boostrap');
    }

    // static function enqueue_placeholder_script() {
    //     if ( ! self::$add_placeholder_script )
    //         return;
    //     wp_enqueue_scripts('sagaio-udm-placeholder');
    // }
